...
class TestCreateDbDecommissionWorkflow:
    ...
    def test_backward_compatibility_with_parameters(self):
        ...
        workflow = create_db_decommission_workflow(
            ...
            target_repos=["https://github.com/test/repo1", "https://github.com/test/repo2"],
        ...
        assert repo_step.parameters["target_repos"] == ["https://github.com/test/repo1", "https://github.com/test/repo2"]
    ...
    def test_default_repositories_fallback(self):
        ...
        repo_step = workflow.steps[1]
        assert repo_step.parameters["target_repos"] == ["https://github.com/bprzybys-nc/postgres-sample-dbs"]
...
class TestParameterManagement:
    ...
    def test_parameter_consistency_across_steps(self):
        ...
        assert validation_step.parameters["workflow_id"] == summary_step.parameters["workflow_id"]
    ...
    def test_parameter_management_methods_return_expected_structure(self):
        ...
        expected_repo_keys = {"database_name", "workflow_id", "target_repos", "slack_channel"}
        assert set(repo_params.keys()) == expected_repo_keys
        
        # Test GitHub params
        github_params = builder._github_params()
        expected_github_keys = {"database_name", "workflow_id", "repo_owner", "repo_name"}
