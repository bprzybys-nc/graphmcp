...
class TestPreviewMCPMain:
    ...
    async def test_main_function_success(
        self, mock_logging_config, mock_executor_class, mock_server_class
    ):
    ...
    async def test_main_function_keyboard_interrupt(
        self, mock_logger, mock_logging_config, mock_executor_class, mock_server_class
    ):
    ...
    @patch("clients.preview_mcp.__main__.logging.basicConfig")
    @patch("clients.preview_mcp.__main__.logger")
    async def test_main_function_logging_messages(
        self, mock_logger, mock_logging_config, mock_executor_class, mock_server_class
    ):
    ...
    async def test_executor_creation_error(self, mock_executor_class):
        ...
        with (
            patch("clients.preview_mcp.__main__.logger") as mock_logger,
