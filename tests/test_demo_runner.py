...
class TestDemoConfig:
    ...
    def test_config_from_env(self):
        ...
        with patch.dict(
            os.environ,
            {"DEMO_MODE": "real", "TARGET_DATABASE": "custom_db", "CACHE_TTL": "7200"},
        ):
...
class TestWorkflowSteps:
    ...
    async def test_generate_refactoring_plan_step(self):
        ...
        assert result["plan"]["recommended_approach"] in [
            "gradual_migration",
            "direct_removal",
        ]
...
class TestErrorHandling:
    ...
    async def test_mock_mode_missing_cache(self):
        ...
        with patch("demo.runner.DemoCache") as mock_cache_class:
            ...
            with pytest.raises(
                ValueError, match="Mock mode requested but no cached repo data found"
            ):
