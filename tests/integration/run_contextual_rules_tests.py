...
class IntegrationTestRunner:
    ...
    def run_tests(
        ...
        try:
            ...
            test_commands = self._build_test_commands(
                pattern, performance_only, skip_performance
            )
    ...
    def _setup_environment(self):
        ...
        required_modules = ["utils.source_type_classifier"]
    ...
    def _build_test_commands(
        self, pattern: str, performance_only: bool, skip_performance: bool
    ) -> Dict[str, List[str]]:
        ...
        if performance_only:
            commands["Performance Tests"] = [
                ...
                "-m",
                "pytest",
                f"{base_path}::TestContextualRulesEnginePerformance",
                "-v",
            ]
        else:
            ...
            commands["Rule Definitions"] = [
                ...
                "-m",
                "pytest",
                f"{base_path}::TestContextualRulesEngineIntegration::test_load_infrastructure_rules",
            ...
            commands["Framework Detection"] = [
                ...
                "-m",
                "pytest",
                f"{base_path}::TestContextualRulesEngineIntegration::test_terraform_framework_detection",
            ...
            commands["Pattern Matching"] = [
                ...
                "-m",
                "pytest",
                f"{base_path}::TestContextualRulesEngineIntegration::test_terraform_resource_pattern_matching",
            ...
            commands["Rule Actions"] = [
                ...
                "-m",
                "pytest",
                f"{base_path}::TestContextualRulesEngineIntegration::test_comment_out_patterns_method",
            ...
            commands["End-to-End Processing"] = [
                ...
                "-m",
                "pytest",
                f"{base_path}::TestContextualRulesEngineIntegration::test_terraform_file_processing_end_to_end",
            ...
            commands["Error Handling"] = [
                ...
                "-m",
                "pytest",
                f"{base_path}::TestContextualRulesEngineIntegration::test_empty_file_processing",
    ...
    def _run_test_command(self, test_name: str, command: List[str]):
        ...
        try:
            ...
            print(f"⏱️ {error_msg}")
            self.results["errors"].append(
                {"test": test_name, "error": "Timeout after 5 minutes"}
            )
    ...
    def _generate_report(self):
        ...
        print(
            f"   • Success Rate: {(self.results['passed'] / total_tests * 100):.1f}%"
            if total_tests > 0
        ...
        if self.results["errors"]:
            ...
            for error in self.results["errors"]:
                if isinstance(error, dict):
                    print(
                        f"   • {error.get('test', 'Unknown')}: {error.get('error', 'Unknown error')}"
                    )
                else:
                    print(f"   • {error}")
    ...
    def _generate_recommendations(self):
        ...
        slow_tests = [
            name
            for name, duration in self.results["performance_metrics"].items()
