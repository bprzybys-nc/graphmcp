...
class TestMinimalIntegration:
    ...
    async def test_basic_workflow_import(self):
        ...
        try:
            ...
            workflow = WorkflowBuilder(
                "minimal-test", "clients/mcp_config.json"
            ).build()
    ...
    async def test_simple_github_workflow(self):
        ...
        try:
            ...
            workflow = (
                WorkflowBuilder("github-test", "clients/mcp_config.json")
                .step(
                    "validate",
                    "Simple Validation",
                    lambda context, step, **params: validate_result(
                        context, step, **params
                    ),
                )
                .build()
    ...
    async def test_client_imports(self):
        ...
        try:
            from clients import GitHubMCPClient, FilesystemMCPClient
