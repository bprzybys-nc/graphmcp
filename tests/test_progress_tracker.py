...
class TestProgressTracker:
    ...
    async def test_workflow_progress_calculation(self, tracker):
        ...
        assert (
            0.4 < workflow_progress.overall_progress < 0.6
        )  # Should be around 50% of total
    ...
    def test_bandwidth_history_management(self, tracker):
        ...
        assert (
            abs(avg_bandwidth - expected_avg) < 2.5
        )  # Allow for more tolerance due to floating point math
