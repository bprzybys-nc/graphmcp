...
class MCPWorkflowServer:
    ...
    async def _create_workflow(self, args: Dict[str, Any]) -> Dict[str, Any]:
        ...
        for step_data in steps_data:
            context.add_step(
                name=step_data["name"], input_data=step_data.get("input_data", {})
            )
    ...
    async def _execute_workflow(self, args: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            logger.logger.info(
                "Workflow execution started", event_type="workflow_start"
            )
            ...
            for step in context.steps:
                ...
                try:
                    ...
                    output_data = await self.workflow_executor.execute_step(
                        context, step.id
                    )
...
async def create_mcp_server(
    workflow_executor: WorkflowExecutor, log_level: str = "INFO"
) -> MCPWorkflowServer:
