...
class SourceTypeClassifier:
    ...
    def classify_file(
        ...
        if content:
            content_scores, content_patterns, frameworks = self._analyze_content(
                content
            )
    ...
    def _analyze_content(
        self, content: str
    ) -> Tuple[Dict[SourceType, float], List[str], List[str]]:
    ...
    def _get_rule_files(
        self, source_type: SourceType, frameworks: List[str]
    ) -> List[str]:
